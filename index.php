        ...
        <div class="container py-4">
            <div class="row align-items-center gy-3">
                <div class="col-12 col-md">
                    <h2 class="h5 mb-1 text-center text-md-start">Contact Email</h2>
                    <a class="footer-link d-inline-flex align-items-center gap-2" href="mailto:info@chnnd.ir">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-center">
                <p class="mb-0 small opacity-75">© 2025 chnnd.ir — All rights reserved.</p>
                <div class="socials mt-3 mt-md-0 d-flex gap-3">
